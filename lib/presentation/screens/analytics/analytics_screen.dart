  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AppScaffold(
      ...
      child: analyticsAsync.when(
        data: (analytics) => _AnalyticsContent(data: analytics),
    ...
    return ListView(
      children: [
        GridView.count(
          ...
          children: [
            _MetricCard(label: 'Total tasks', value: '${data.totalTasks}', tone: AppColors.accent),
            _MetricCard(label: 'Completed', value: '${data.completedTasks}', tone: AppColors.success),
            _MetricCard(label: 'Active', value: '${data.activeTasks}', tone: AppColors.warning),
            _MetricCard(label: 'Completion rate', value: '${data.completionRate}%', tone: AppColors.accentStrong),
          ],
        ),
